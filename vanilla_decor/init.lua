...
--dofile(minetest.get_modpath('vanilla_decor')..'/carpet.lua')
...
--dofile(minetest.get_modpath('vanilla_decor')..'/flowers_pot_3d.lua')
...
--dofile(minetest.get_modpath('vanilla_decor')..'/pictures_craft.lua')
