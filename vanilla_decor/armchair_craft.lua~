...
minetest.register_craft({
	output = "vanilla_decor:armchair_black 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_white 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_blue 1",
	recipe = {
		{'', '', ''},
		{'wool:blue', '', 'wool:blue'},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_brown 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_cyan 1",
	recipe = {
		{'', '', ''},
		{'wool:cyan', '', 'wool:cyan'},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_dark_green 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_dark_grey 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_green 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_grey 1",
	recipe = {
		{'', '', ''},
		{'wool:grey', '', 'wool:grey'},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_magenta 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_orange 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_pink 1",
	recipe = {
		{'', '', ''},
		{'wool:pink', '', 'wool:pink'},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_red 1",
	recipe = {
		{'', '', ''},
		{'wool:red', '', 'wool:red'},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_violet 1",
	recipe = {
		{'', '', ''},
...
minetest.register_craft({
	output = "vanilla_decor:armchair_yellow 1",
	recipe = {
		{'', '', ''},
