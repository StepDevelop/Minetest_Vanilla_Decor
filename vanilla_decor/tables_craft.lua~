...
minetest.register_craft({
	output = "vanilla_decor:table_wooden_planks 1",
	recipe = {
...
minetest.register_craft({
	output = "vanilla_decor:table_pine_wood 1",
	recipe = {
...
minetest.register_craft({
	output = "vanilla_decor:table_aspen_wood 1",
	recipe = {
...
minetest.register_craft({
	output = "vanilla_decor:table_acacia_wood 1",
	recipe = {
...
minetest.register_craft({
	output = "vanilla_decor:table_jungle_wood 1",
	recipe = {
