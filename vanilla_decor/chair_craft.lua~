...
minetest.register_craft({
	output = "vanilla_decor:chair_wooden_planks 1",
	recipe = {
		{'', '', 'default:wood'},
...
minetest.register_craft({
	output = "vanilla_decor:chair_pine_wood 1",
	recipe = {
		{'', '', 'default:pine_wood'},
...
minetest.register_craft({
	output = "vanilla_decor:chair_acacia_wood 1",
	recipe = {
		{'', '', 'default:acacia_wood'},
...
minetest.register_craft({
	output = "vanilla_decor:chair_aspen_wood 1",
	recipe = {
		{'', '', 'default:aspen_wood'},
...
minetest.register_craft({
	output = "vanilla_decor:chair_jungle_wood 1",
	recipe = {
		{'', '', 'default:junglewood'},
